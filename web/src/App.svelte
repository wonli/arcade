<script>
  const games = [
    ...
    {
      name: 'TETRIS BATTLE',
      kicker: 'SEND GARBAGE. MAKE ENEMIES.',
      glyph: '▦',
      status: 'COMING NEXT',
      className: 'tetris',
    },
    {
      name: 'SNAKE ARENA',
      kicker: 'EAT. GROW. RUIN FRIENDSHIPS.',
      glyph: '━━●',
      status: 'IN THE LAB',
      className: 'snake',
    },
    {
      name: 'CHESS',
      kicker: 'CLASSIC PROBLEMS, NEW SOCKETS.',
      glyph: '♟',
      status: 'LATER',
      className: 'chess',
    },
...
<svelte:head>
  <meta
    name="description"
    content="AQI Arcade — tiny multiplayer games powered by AQI realtime."
  />
</svelte:head>
...
<div class="page-shell">
    ...
    <section class="hero">
      <div class="hero-copy">
        ...
        <h1>
          Pick a game.<br />
          Send the link.<br />
          <span>Beat your friend.</span>
        </h1>
        <p class="hero-note">
          No account. No lobby maze. Just a room, two people, and a suspicious amount of confidence.
        </p>
      </div>
      ...
      <div class="game-grid">
        {#each games as game, index}
          <article class:active={game.active} class="game-card {game.className}">
            ...
            {#if game.active}
              <button onclick={createRoom} class="card-action">
  ...
  <footer>
    <span>POWERED BY AQI</span>
    <span>ROOM → GAME → REMATCH</span>
    <span>NO PRODUCT MANAGERS WERE HARMED</span>
  </footer>
</div>
