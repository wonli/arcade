...
const ART = {
  dagger: { common: new URL('./assets/sword-7soul1_20201212/32x32/dagger_01.png', import.meta.url).href, uncommon: new URL('./assets/sword-7soul1_20201212/32x32/dagger_08.png', import.meta.url).href, rare: new URL('./assets/sword-7soul1_20201212/32x32/dagger_15.png', import.meta.url).href, epic: new URL('./assets/sword-7soul1_20201212/32x32/gold_dagger.png', import.meta.url).href },
  sword: { common: new URL('./assets/sword-7soul1_20201212/32x32/sword_01.png', import.meta.url).href, uncommon: new URL('./assets/sword-7soul1_20201212/32x32/sword_08.png', import.meta.url).href, rare: new URL('./assets/sword-7soul1_20201212/32x32/sword_15.png', import.meta.url).href, epic: new URL('./assets/sword-7soul1_20201212/32x32/gold_sword.png', import.meta.url).href },
  katana: { common: new URL('./assets/sword-7soul1_20201212/32x32/katana.png', import.meta.url).href, uncommon: new URL('./assets/sword-7soul1_20201212/32x32/katana.png', import.meta.url).href, rare: new URL('./assets/sword-7soul1_20201212/32x32/katana.png', import.meta.url).href, epic: new URL('./assets/sword-7soul1_20201212/32x32/katana.png', import.meta.url).href },
}
...
export function weaponPose(player, facing = 'down', { attacking = false, reachScale = 1 } = {}) {
  ...
  return { x, y, angle: base.angle, flipX: facing === 'right', depth: attacking ? 22 : 18, tip: { x: x + (base.tipDx ?? 0) * reachScale, y: y + (base.tipDy ?? 0) * reachScale } }
}
