export const DUNGEON_MESSAGES = Object.freeze({
  'zh-CN': Object.freeze({
    ...
    restEntered: '发现休息层，靠近篝火选择奖励。', restChoice: '已选择：{choice}', openChest: '打开宝箱', chestOpened: '宝箱开启！', openDoor: '打开门', doorOpened: '门已打开！',
  ...
  en: Object.freeze({
    ...
    restEntered: 'Rest floor found. Approach the camp to choose.', restChoice: 'Selected: {choice}', openChest: 'Open Chest', chestOpened: 'Chest opened!', openDoor: 'Open Door', doorOpened: 'Door opened!',
