...
<style>
  ...
  @media(max-width:720px){.page{padding:6px;grid-template-rows:auto minmax(0,1fr)}header strong{display:none}footer{display:none}.players span:first-child{display:none}.stage-shell{width:100%;height:100%}.stage :global(canvas){width:100%!important;height:100%!important;max-width:none!important;max-height:none!important}.touch-controls{display:block}.joystick{left:10px;bottom:max(16px,env(safe-area-inset-bottom))}.joystick :global(.virtual-joystick){width:100px!important;height:100px!important}.joystick :global(.joystick-knob){left:33px!important;top:33px!important;width:34px!important;height:34px!important}.touch-actions{right:10px;bottom:max(16px,env(safe-area-inset-bottom));gap:8px}.touch-actions button{width:58px;height:58px}.touch-actions .skill{width:64px;height:64px}.stats-overlay{padding:8px;align-items:end}.stats-panel{width:100%;padding:16px}.stat-grid{grid-template-columns:1fr 1fr}.stat-grid>div{border-bottom:1px solid rgba(71,80,91,.4)}.panel-actions{grid-template-columns:1fr}}
  @media(orientation:landscape) and (max-height:600px){.page{padding:0;grid-template-rows:minmax(0,1fr);gap:0}header{display:none}footer{display:none}.stage-shell{width:100%;height:100%}.stage :global(canvas){width:100%!important;height:100%!important;max-width:none!important;max-height:none!important}.touch-controls{display:block}.joystick{left:8px;bottom:max(8px,env(safe-area-inset-bottom))}.joystick :global(.virtual-joystick){width:82px!important;height:82px!important}.joystick :global(.joystick-knob){left:27px!important;top:27px!important;width:28px!important;height:28px!important}.touch-actions{right:8px;bottom:max(8px,env(safe-area-inset-bottom));gap:6px}.touch-actions button{width:48px;height:48px;font-size:9px}.touch-actions .skill{width:56px;height:56px}}
</style>
