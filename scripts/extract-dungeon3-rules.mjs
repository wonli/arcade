...
export function extractDungeon3Rules(xml) {
  ...
  return {
    ...
    motifs:{coffins:motifs('coffins',/^Objects/,4).filter(m=>m.cells.length===m.width*m.height),otherObjects:motifs('other_objects',/^Objects/),plates:motifs('plates',/^plates/),stairs:motifs('stairs',/./,4),doors:motifs('doors',/^Objects/,2)},
  }
}
